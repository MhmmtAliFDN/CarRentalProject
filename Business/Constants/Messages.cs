...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarsListedByBrandId = "Car listed by brand id successfully.";
        public static string CarsListedByColorId = "Car listed by color id successfully.";
        ...
        public static string CarImageListed = "Car image listed successfully.";
        ...
        public static string AuthorizationDenied = "You are not authorized to run this method";
    }
}
